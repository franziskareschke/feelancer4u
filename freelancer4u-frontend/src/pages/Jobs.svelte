<script>
  ...
  import { isAuthenticated, jwt_token, myFreelancerId } from "../store";
...
<div class="row my-3">
  ...
  <div class="col-3">
    <select bind:value={jobType} class="form-select" id="type">
      <option value="ALL" /> <option value="OTHER">OTHER</option>
      <option value="TEST">TEST</option>
      <option value="IMPLEMENT">IMPLEMENT</option>
      <option value="REVIEW">REVIEW</option>
    </select>
